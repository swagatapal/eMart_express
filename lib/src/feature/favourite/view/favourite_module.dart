...
import 'package:emart_express/src/feature/favourite/components/favourite_horizontal_list_item.dart';
...
class FavouriteModule extends StatelessWidget {
  FavouriteModule({super.key});
                ...
                child: Consumer<FavouriteProvider>(
                  builder: (context, filterProvider, child) {
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        bool isSelected =
                            filterItems[index] == filterProvider.selectedFilter;
                        return GestureDetector(
                          onTap: () {
                            filterProvider
                                .setSelectedFilter(filterItems[index]);
                            Navigator.pop(context);
                          },
                          child: Container(
                            color: isSelected
